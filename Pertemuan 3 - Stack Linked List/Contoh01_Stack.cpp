...
int main() {
    ...
    cout << "============================================" << endl;
    push("452321066", "Budi", 88.75, &S);
    push("452321077", "Susi", 78.85, &S);
    push("452321088", "Nuri", 98.65, &S);
    push("452321099", "Bimo", 68.55, &S);
    push("452321055", "Arif", 78.85, &S);
    push("452321044", "Rido", 98.65, &S);
    push("452321022", "Ella", 68.55, &S);
